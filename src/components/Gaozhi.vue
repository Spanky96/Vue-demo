  ...
  <div>
    <page id="gaozhi" style="background:#FBF4DA;overflow-y: scroll;">
      ...
      <div class="content" v-html="activeContent">
        ...
        <!-- <p>评价时，请按照测评要求，镇（街道）、开放园区围绕“经济发展、民生改善、服务群众、社会和谐、党风政风”五个方面，市级机关围绕“依法行政、服务发展、作风效能、廉政勤政”四个方面内容。请您结合平时掌握的情况，对85个参评单位作出客观公正的评议。点击单位名称，可参阅该单位年度推进（服务）高质量发展工作实绩简介。</p> -->
      </div>
...
export default {
  ...
  data () {
    var active = this.$db.get('active');
    return {
      activeName: active.actName,
